export async function changePasswordTemplate(name: string) {
    return `<!DOCTYPE html>
        <html lang="en">
            <head>
                <meta charset="UTF-8" />
                ...
                <div class="wrapper" style="width: 465px; margin-left: auto; margin-right: auto">
                    ...
                    <div class="container" style="background: #fff">
                        <div class="containt" style="padding: 0px 20px">
                            ...
                            <p style="font-size: 14px; color: #575656; font-family: 'Montserrat', sans-serif; margin-top: 0px">Password has been changed successfully.</p>
