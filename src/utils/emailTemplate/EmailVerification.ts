export function emailVerification(otp: string, name: string) {
    return `<!DOCTYPE html>
        <html lang="en">
            <head>
                <meta charset="UTF-8" />
                    ...
                    <div class="container" style="background: #fff">
                        <div class="containt" style="padding: 0px 20px">
                            ...
                            <p style="font-size: 14px; color: #575656; font-family: 'Montserrat', sans-serif; margin-top: 0px">
                                Welcome to Homebyz. We are so excited to have you get started. We need you to verify your email address.
                            </p>
                            <p style="font-size: 14px; color: #575656; font-family: 'Montserrat', sans-serif; margin-top: 0px">Enter this 6 digit OTP and verify your email address.</p>
                            <div class="otp">
